...
def init_hf_bert_inbatch_biencoder(args, **kwargs):
    if importlib.util.find_spec("transformers") is None:
        raise RuntimeError('Please install transformers lib')
    from .hf_models import get_bert_inbatch_biencoder_components
    return get_bert_inbatch_biencoder_components(args, **kwargs)
...
BIENCODER_INITIALIZERS = {
    ...
    'hf_inbatch_bert': init_hf_bert_inbatch_biencoder,
