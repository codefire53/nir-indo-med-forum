...
def add_encoder_params(parser: argparse.ArgumentParser):
    ...
    """
    parser.add_argument("--pretrained_model_cfg", default="indobenchmark/indobert-base-p2", type=str, help="config name for model initialization")
    ...
    parser.add_argument('--pretrained_file', default=None, type=str, help="Some encoders need to be initialized from a file")
    ...
    parser.add_argument("--fix_ctx_encoder", action="store_true", help="fix context encoder.")
    parser.add_argument("--padding", type=bool, default=False,  help="Turn on/off padding")
...
def add_training_params(parser: argparse.ArgumentParser):
    ...
    parser.add_argument("--log_batch_step", default=10, type=int, help="")
