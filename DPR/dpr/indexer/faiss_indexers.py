...
class DenseIndexer(object):
    ...
    def search_knn(self, query_vectors: np.array, top_docs: int, convert_to_external_id=True)-> List[Tuple[List[object], List[float]]]:
        raise NotImplementedError
...
class DenseFlatIndexer(DenseIndexer):
    ...
    def search_knn(self, query_vectors: np.array, top_docs: int, convert_to_external_id=True) -> List[Tuple[List[object], List[float]]]:
        ...
        db_ids = [[self.index_id_to_db_id[i] for i in query_top_idxs] for query_top_idxs in indexes] if convert_to_external_id else  [[i for i in query_top_idxs] for query_top_idxs in indexes]
